...
btn2 = tk.Button(frame1, text='Rectangle', height=90, width=180, fg='green', command=rect_noise, compound='left', image=btn2_image)
btn2['font'] = btn_font
...
btn4 = tk.Button(frame1, text='Record', height=90, width=180, fg='green', command=record, image=btn4_image, compound='left')
btn4['font'] = btn_font
